    ...
    return(
        <>
            <div>
                ...
                <a href='https://www.figma.com/file/EcFFIzK9y2qWxiCuhWj4S0/Ostello()?node-id=0%3A1' target='_blank' rel="noreferrer" className="designLink">View Design<i className="fa fa-magic fa-lg ps-1"></i></a>
